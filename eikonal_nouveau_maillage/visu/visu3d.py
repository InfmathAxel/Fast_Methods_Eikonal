...
plotMatrices3DSubplots([matrixFIM, matrixex, matrix_error_FIM], ['FIM','Exact', 'Error FIM'])
#plotMatrices3DSubplots([matrixFSM, matrixex, matrix_error_FSM], ['FSM','Exact', 'Error FSM'])
